...
if (!empty($_POST['username']) && !empty($_POST['password'])) {
		...
		$records = $conn->prepare("SELECT * FROM usuarios WHERE usuario = ? AND pass = ?");
		$records->bind_param('ss', $_POST['username'],$_POST['password']);
		$records->execute();
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form"method='post' action='index2.php' >
					...
					<div class="wrap-input100 validate-input" data-validate = "Usuario necesario">
							<input class="input100" type="text" id="username"  name="username" pattern="[a-zA-Z]{1,15}">
					...
					<input class="input100" type="password" name="password"  pattern="[A-Za-z0-9\.]+" >
						<span class="focus-input100"></span>
